...
begin
  Result := rdoSetLocal.Checked and not rdoSetUTC.Checked;
end;
...
begin
  ...
  lblSystemTime.Caption := FormatDateTime('hh:nn:ss', ShowDT);
end;
...
begin
  ...
  if edtEnableLogging.Checked then
    LogLine(ALine);
...
begin
  ...
  try
    ...
    memLogWindow.Perform(EM_SCROLLCARET, 0, 0);
    memLogWindow.Perform(WM_VSCROLL, SB_BOTTOM, 0);
  finally
